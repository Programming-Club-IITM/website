    ...
    events: [
      {
        ...
        date: '2025-09-21',
        category: 'past',
        description: 'The Programming Club presents CODE ARENA! (Proudly sponsored by IMC). Get ready for Insti’s biggest programming contest yet – a battle of logic, speed, and problem-solving with a 16K prize pool up for grabs!\n\n*Perfect for competitive programmers of all levels looking to test their skills, win prizes, and potentially join the CP Guild.*',
        poster: 'events/codearena/codearena.jpg',
        posters: ['events/codearena/g1.jpg', 'events/codearena/g2.webp', 'events/codearena/g3.webp', 'events/codearena/g4.webp', 'events/codearena/g5.webp', 'events/codearena/g6.webp'],
        venue: 'RJN Block',
    ...
    events: [
      {
        ...
        date: '2026-01-24',
        category: 'past',
        description: 'The Programming Club at IIT Madras invites you to BitShift 2026, a premier all-India competitive programming contest proudly sponsored by Jane Street! Battle it out for a massive ₹70,000 prize pool.\n\n*A perfect opportunity for college students across the nation to test their algorithmic prowess, climb the leaderboard, and win big.*',
    ...
    events: [
      {
        ...
        date: '2026-02-14',
        category: 'past',
        description: 'The Programming Club, IIT Madras is excited to invite you to DeadLock 2026, our first-ever Software Development Contest! Proudly sponsored by IMC Trading, this competition goes beyond standard algorithms to test real-world coding efficiency.\n\n*Perfect for 1st and 2nd-year developers ready to push their system skills and compete for a massive ₹50,000 prize pool.*',
        poster: 'events/deadlock/deadlock.jpg',
        posters: ['events/deadlock/g1.webp', 'events/deadlock/g2.webp', 'events/deadlock/g3.webp', 'events/deadlock/g4.webp', 'events/deadlock/g5.webp'],
        venue: 'Online',
